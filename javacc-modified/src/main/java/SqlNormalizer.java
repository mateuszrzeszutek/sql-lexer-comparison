...
public class SqlNormalizer implements SqlNormalizerConstants {
   ...
   public static String normalize(String s) throws ParseException {
     ...
     StringBuilder answer = parser.Input();
  ...
  final public StringBuilder Input() throws ParseException {
    ...
    while (true) {
      ...
      case KeywordOrIdentifier:
        t = jj_consume_token(KeywordOrIdentifier);
                t.appendImageTo(sb, jj_input_stream);
                if (sb.length() > LIMIT) { {if (true) return sb;} }
        break;
      case BasicNum:
      ...
      case DoubleQuotedStr:
        ...
        break;
      case DollarQuotedStr:
        t = jj_consume_token(DollarQuotedStr);
                sb.append('?');
                if (sb.length() > LIMIT) { {if (true) return sb;} }
        break;
      case Whitespace:
